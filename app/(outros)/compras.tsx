...
const img_shopping_card = require("../../assets/images/shopping.png");
          ...
          <View style={{ alignItems: "center", marginTop: 20, gap: 15 }}>
            <View style={styles.containercard}>
              ...
              <View style={styles.direita}>
                <View>
                  <Text style={styles.textoNome}>Mercado</Text>
                  <Text>12:43</Text>
                </View>
                <Text style={styles.textoValorcard}>R$ 500,00</Text>
              </View>
            </View>
          </View>
        </ScrollView>
